...
async function run() {
  try {
    ...
    //verify admin API from verifyToken
    ...
    app.post('/payments', async (req, res) => {
      ...
      //carefully delete each item form the cart, or in easy terms clean the cart
...
app.listen(port, () => {
  console.log('Server is cooking at the designated port')
})